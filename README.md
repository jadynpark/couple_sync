...
The .mat files contain preprocessed, normalized oxygenated hemoglobin time courses. The dimensions are:  

nSamples x nChannels x nSubjects = 6104 x 20 x 80  

(one couple was omitted due to device failure).  
